    ...
    function salvar() {
        ...
        if (idEmpresa != null) { //Alteração:
            axios.put("http://localhost:8080/api/empresa/" + idEmpresa, empresaRequest)
                .then((response) => { alert('Empresa alterada com sucesso.') })
                .catch((error) => { alert('Erro ao alterar um empresa.') })
        } else { //Cadastro:
            axios.post("http://localhost:8080/api/empresa", empresaRequest)
                .then((response) => { alert('Empresa cadastrada com sucesso.') })
                .catch((error) => { alert('Erro ao incluir o empresa.') })
        }
    }
